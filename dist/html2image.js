...
/* harmony export (immutable) */ __webpack_exports__["default"] = html2image;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__html2canvas__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__html2canvas___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__html2canvas__);
/*
...
function html2image(element, options) {
	const h2i = {};
	const h2c = __WEBPACK_IMPORTED_MODULE_0__html2canvas___default()(element, options);
...
var _BezierCurve = __webpack_require__(25);
...
var _Size = __webpack_require__(24);
...
var testForeignObject = function testForeignObject(document) {
    ...
    var svg = (0, _ForeignObjectRenderer.createForeignObjectSVG)(size, size, img);
    ctx.fillStyle = 'red';
    ctx.fillRect(0, 0, size, size);
    ...
    return (0, _ForeignObjectRenderer.loadSerializedSVG)(svg).then(function (img) {
        ...
        return isGreenPixel(data) ? (0, _ForeignObjectRenderer.loadSerializedSVG)((0, _ForeignObjectRenderer.createForeignObjectSVG)(size, size, node)) : Promise.reject(false);
    }).then(function (img) {
        ctx.drawImage(img, 0, 0);
...
var _borderRadius = __webpack_require__(26);

var _display = __webpack_require__(27);

var _float = __webpack_require__(28);

var _font = __webpack_require__(29);

var _letterSpacing = __webpack_require__(30);

var _overflow = __webpack_require__(31);

var _padding = __webpack_require__(32);

var _position = __webpack_require__(14);

var _textDecoration = __webpack_require__(8);

var _textShadow = __webpack_require__(33);

var _textTransform = __webpack_require__(15);

var _transform = __webpack_require__(34);

var _visibility = __webpack_require__(35);

var _zIndex = __webpack_require__(36);
...
var _punycode = __webpack_require__(37);
...
var createForeignObjectSVG = exports.createForeignObjectSVG = function createForeignObjectSVG(width, height, node) {
...
var _NodeParser = __webpack_require__(22);
...
var renderElement = exports.renderElement = function renderElement(element, options, logger) {
    ...
    // $FlowFixMe
    return _Feature2.default.SUPPORT_FOREIGNOBJECT_DRAWING.then(function (supportForeignObject) {
...
var _StackingContext = __webpack_require__(23);
...
var _Angle = __webpack_require__(43);
...
var _Proxy = __webpack_require__(46);
        ...
        xhr.onload = function () {
            if (xhr instanceof XMLHttpRequest) {
                if (xhr.status === 200) {
                    ...
                    reject( true ? 'Failed to proxy image ' + src.substring(0, 256) + ' with status code ' + xhr.status : '');
                }
            } else {
